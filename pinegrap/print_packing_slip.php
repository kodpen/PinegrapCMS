...
if ($ship_to['phone_number'] != '') {
    $output_ship_to_phone_number = '<br />' . lang('Phone') . ': ' . h($ship_to['phone_number']);
}
            ...
            <table style="margin-bottom: 1em">
                <tr>
                    <td style="padding-right: 1em">
                        <h1>' . lang('Packing Slip') . '</h1>
                      <div class="text" style="display:inline">' . lang('Order') . '</div> #: ' . $order['order_number'] . '<br/>
                       <div class="text" style="display:inline">' . lang('Order Date') . ':</div> <time>' . get_absolute_time(array('timestamp' => $order['order_date'])) . '</time>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="padding-right: 1em">
                        <h2 style="margin-top: .5em">' . lang('Ship to') . ':</h2>
                    ...
                    <td>
                        <p style="margin-top: 3.5em"><div class="text" style="display:inline">' . lang('Shipping Method') . ': </div>' . $output_shipping_method . '</p>
                    </td>
                </tr>
            </table>
