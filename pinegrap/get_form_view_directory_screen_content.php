...
function get_form_view_directory_screen_content($properties) {
    ...
    if ($summary == 1) {
        ...
        if ($summary_days == 1) {
            $output_summary_days = lang('last day');
            
        // else summary days is not equal to 1, so output a different summary days message
        } else {
            $output_summary_days = lang(array('string'=>'last {var:1} days','vars'=>$summary_days ));
        }
                ...
                $output_summary_table =
                    '<table id="software_form_view_directory_summary_table_most_recent">
                        <tr class="heading" style="border: none">
                            ...
                            <th class="mobile_left" style="padding: 0em 1em 0em 0em; text-align: right; vertical-align: top; white-space: nowrap">' . lang('Comments') . '</th>
                            <th class="mobile_left" style="padding: 0em 1em 0em 0em; text-align: right; vertical-align: top; white-space: nowrap">' . lang('Views') . '</th>
                            <th class="mobile_left" style="padding: 0em 1em 0em 0em; text-align: left; vertical-align: top; white-space: nowrap">' . lang('Last Post') . '</th>
                        </tr>
                        ' . $output_most_recent_submitted_form_rows . '
                    </table>';
        ...
        $output_summary =
            '<fieldset class="software_fieldset" style="margin-bottom: 1em">
                <legend class="software_legend">' . lang('Summary') . ' (' . $output_summary_days . ')</legend>
                    <div class="filters" style="margin-bottom: .5em">
                        <a href="' . h($most_recent_url) . '" id="software_form_view_directory_summary_link_most_recent"' . $output_most_recent_link_style . '>' . lang('Most Recent') . '</a>&nbsp;&nbsp;
                        <a href="' . h($most_viewed_url) . '" id="software_form_view_directory_summary_link_most_viewed"' . $output_most_viewed_link_style . '>' . lang('Most Viewed') . '</a>&nbsp;&nbsp;
                        <a href="' . h($most_active_url) . '" id="software_form_view_directory_summary_link_most_active"' . $output_most_active_link_style . '>' . lang('Most Active') . '</a>
                    </div>
                    <div>
                        ' . $output_summary_table . '
                    </div>
