...
if (!$_POST) {
    ...
    pg_page_shell([
        ...
        'heading_description' => lang('Create a new shipping method that will be made available during checkout based on the products and destination address.'),
...
<main id="content" class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4 my-2">
                                            ...
                                            <input type="text" name="name" placeholder="' . lang('Shipping Method Name') . '" id="name" maxlength="50" class="form-control" />
                                        </div>
    ...
    $query = "INSERT INTO shipping_methods (
            ...
            VALUES (
                ...
                '" . escape(pg_carrier_number_clean($_POST['carrier_vkn'] ?? '')) . "',
                '" . escape($status) . "',
