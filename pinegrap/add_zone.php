...
if (!$_POST) {
    ...
    pg_page_shell([
        ...
        'heading_description' => lang('Create a new shipping zone that will be used to calculate shipping during checkout based on the products and shipping addresses.'),
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-lg-6 my-2">
                                            ...
                                            <input type="text" name="name" placeholder="' . lang('Zone Name') . '" id="name" maxlength="50" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 my-1">
                                            ...
                                            <select style="width:100%" class="select2 form-select" data-placeholder="' . lang('Click to select country(s)') . '" id="allowed_countries" name="allowed_countries[]" multiple="multiple">' . $output_disallowed_countries . '</select>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 my-1">
                                            ...
                                            <select style="width:100%" class="select2 form-select" data-placeholder="' . lang('Click to select state(s)') . '" id="allowed_states" name="allowed_states[]" multiple="multiple">' . $output_disallowed_states . '</select>
                                        </div>
                                    </div>
                                </div>
                            </div>
