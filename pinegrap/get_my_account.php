...
function get_my_account($properties) {
    ...
    if (ECOMMERCE) {
        ...
        // If there is at least one complete, canceled, or incomplete order, then continue to prepare them.
        if ($complete_orders or $canceled_orders or $incomplete_orders) {
            ...
            // Loop through the canceled orders in order to prepare info.
