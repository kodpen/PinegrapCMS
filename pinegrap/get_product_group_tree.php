...
$expanded_product_groups = isset($_COOKIE['software']['product_group_tree']['expanded_product_groups']) ? explode(',', $_COOKIE['software']['product_group_tree']['expanded_product_groups']) : [];

// output xml content
header("Content-type: text/xml");
echo '<?xml version="1.0" encoding="utf-8"?>';
echo '<root>';
echo get_product_group_tree(isset($_GET['product_group_id']) ? $_GET['product_group_id'] : 0);
echo '</root>';
