...
if (isset($_SESSION['software']['ecommerce']['view_tax_zones']['sort']) == false) {
    $_SESSION['software']['ecommerce']['view_tax_zones']['sort'] = '';
}
...
echo
    pg_page_shell([
        ...
        'heading_description' => lang('All geographic areas where your organization collects tax for any product.'),
    ]) . '
