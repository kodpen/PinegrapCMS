...
if (mysqli_num_rows($result) > 0) {
    ...
    <nav id="header" class="navbar sticky-top rounded-0 navbar-expand border-bottom shadow-sm bg-body">
        <div class="container-fluid">
            <span class="navbar-text me-auto" data-bs-content="' . lang('A function for sending e-mails to recipients') . '" title="' . lang('Send E-mail Campaign') . '">' . lang('Send E-mail Campaign') . '</span>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p>' . lang('From Name') . ': ' . h($from_name) . '</p>
                        <p>' . lang('From E-mail Address') . ': ' . h($from_email_address) . '</p>
                        <p>' . lang('Reply to E-mail Address') . ': ' . h($reply_email_address) . '</p>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <h3>' . lang('Sending Campaign Now') . '...</h3>
                <p>' . lang('Sending the e-mail message to each specific subscriber now.') . '</p>
        ...
        <nav class="buttons navigation text-center position-sticky" style="bottom:.5rem;" aria-label="data edit buttons ">
            <div class="container">
                <div class=" btn-group btn-group-sm flex-wrap justify-content-center mb-0">
                    <button type="button" name="submit_save" onclick="window.close();" value="Stop &amp; Close" class="btn mb-1 mt-1  btn-danger submit-primary" ><span class="material-icons me-2">close</span>' . lang(array('string'=>'Stop & Close') ) . '</button>
                </div>
            </div>
        </nav>
...
// else there is not at least one e-mail recipient left, so e-mail campaign is complete
    ...
    if ($format == 'html') {
        $log_page = ', ' . lang('page') . ': ' . get_page_name($page_id);
    }
    ...
    <nav id="header" class="navbar sticky-top rounded-0 navbar-expand border-bottom shadow-sm bg-body">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <button title="' . lang('Close') . '" type="button" class="nav-link nav-link-sm position-relative no-popover" onclick="window.opener.location.reload(true); window.close();" aria-label="Close">
                        <span class="bi bi-x-lg"></span>
                    </button>
                </li>
            </ul>
    ...
    <main id="content" class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <h3>' . lang('Campaign Sent') . '.</h3>
                <div class="alert alert-success"><p>' . lang('The e-mail campaign has been sent to all recipients.') . '</p></div>
            </div>
        </div>
        <nav class="buttons navigation text-center position-sticky" style="bottom:.5rem;" aria-label="data edit buttons ">
            <div class="container">
                <div class=" btn-group btn-group-sm flex-wrap justify-content-center mb-0">
                    <button type="button" name="submit_save" value="Close" onclick="window.opener.location.reload(true); window.close();" class="btn mb-1 mt-1  btn-secondary submit-primary" ><span class="material-icons me-2">close</span>' . lang(array('string'=>'Close') ) . '</button>
                </div>
            </div>
        </nav>
    </main>' . output_footer_secure();
...
{
    $output = '<div style="color: red">' . lang('Error') . ': ' . $error_message . '</div>';
    print $output;
    exit();
}