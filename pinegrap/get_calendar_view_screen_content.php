...
function get_calendar_view_screen_content($properties) {
    ...
    $output_calendar_views_date = '';
    if(isset($_SESSION['software']['calendar_views'][$current_page_id]['date'])){
        $output_calendar_views_date = $_SESSION['software']['calendar_views'][$current_page_id]['date'];
    }
    $output_calendar_views_calendar_id = '';
    if(isset($_SESSION['software']['calendar_views'][$current_page_id]['calendar_id'])){
        $output_calendar_views_calendar_id = $_SESSION['software']['calendar_views'][$current_page_id]['calendar_id'];
    }


    return get_calendar($output_calendar_views_calendar_id, $calendars, $_SESSION['software']['calendar_views'][$current_page_id]['view'], 'published', '', $output_calendar_views_date, $link, $number_of_upcoming_events);
}