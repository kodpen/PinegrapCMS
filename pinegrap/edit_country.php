...
if (!$_POST) {
    ...
    $output =
        pg_page_shell([
            ...
            'heading_description' => lang('Edit a country that can be included in any shipping zone or tax zone.'),
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-4 my-2">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control" maxlength="50" value="' . h($name) . '" />
