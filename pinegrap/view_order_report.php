...
if (!$_POST) {
    ...
    if (isset($_GET['id']) == false) {
        $output_screen_name = lang('Create Order Report');
        
    // else an order report is being viewed, so prepare screen name
    } else {
        $output_screen_name = lang('View Order Report') . ': <strong>' . $liveform->get_field_value('name') . '</strong>';
    }
    ...
    $summarize_by_options[lang('Order Status')] = 'order_status';
    $summarize_by_options[lang('Special Offer Code')] = 'special_offer_code';
    $summarize_by_options[lang('Referral Source Code')] = 'referral_source_code';
    $summarize_by_options[lang('Reference Code')] = 'reference_code';
    $summarize_by_options[lang('Tracking Code')] = 'tracking_code';
    $summarize_by_options[lang('Referring URL')] = 'http_referer';
    ...
    $summarize_by_options[lang('Customer\'s IP Address')] = 'ip_address';
    ...
    $summarize_by_options[lang('Payment')] = '<optgroup>';
    $summarize_by_options[lang('Payment Method')] = 'payment_method';
    $summarize_by_options[lang('Card Type')] = 'card_type';
    $summarize_by_options[lang('Cardholder')] = 'cardholder';
    $summarize_by_options[lang('Card Number')] = 'card_number';
    $summarize_by_options[''] = '</optgroup>';
    $summarize_by_options[lang('Billing')] = '<optgroup>';
    $summarize_by_options[lang('Custom Field #1')] = 'custom_field_1';
    $summarize_by_options[lang('Custom Field #2')] = 'custom_field_2';
    $summarize_by_options[lang('Billing Salutation')] = 'billing_salutation';
    $summarize_by_options[lang('Billing First Name')] = 'billing_first_name';
    $summarize_by_options[lang('Billing Last Name')] = 'billing_last_name';
    $summarize_by_options[lang('Billing Company')] = 'billing_company';
    $summarize_by_options[lang('Billing Address 1')] = 'billing_address_1';
    $summarize_by_options[lang('Billing Address 2')] = 'billing_address_2';
    $summarize_by_options[lang('Billing City')] = 'billing_city';
    $summarize_by_options[lang('Billing State')] = 'billing_state';
    $summarize_by_options[lang('Billing Zip Code')] = 'billing_zip_code';
    $summarize_by_options[lang('Billing Country')] = 'billing_country';
    $summarize_by_options[lang('Billing Phone')] = 'billing_phone_number';
    $summarize_by_options[lang('Billing Fax')] = 'billing_fax_number';
    $summarize_by_options[lang('Billing Email')] = 'billing_email_address';
    $summarize_by_options[lang('Opt-In Status')] = 'opt_in_status';
    $summarize_by_options[lang('PO Number')] = 'po_number';
    $summarize_by_options[lang('Tax Status')] = 'tax_status';
    $summarize_by_options[''] = '</optgroup>';
    ...
    $field_options[] = array('name' => lang('Order Date'), 'value' => 'order_date', 'type' => 'date');
    $field_options[] = array('name' => lang('Order Status'), 'value' => 'order_status', 'value_options' => array(array('name' => lang('Incomplete'), 'value' => 'incomplete'), array('name' => lang('Complete'), 'value' => 'complete'), array('name' => lang('Exported'), 'value' => 'exported')));
    $field_options[] = array('name' => lang('Order Number'), 'value' => 'order_number');
    $field_options[] = array('name' => lang('Transaction ID'), 'value' => 'transaction_id');
    $field_options[] = array('name' => lang('Authorization Code'), 'value' => 'authorization_code');
    $field_options[] = array('name' => lang('Special Offer Code'), 'value' => 'special_offer_code');
    $field_options[] = array('name' => lang('Referral Source Code'), 'value' => 'referral_source_code');
    $field_options[] = array('name' => lang('Reference Code'), 'value' => 'reference_code');
    $field_options[] = array('name' => lang('Tracking Code'), 'value' => 'tracking_code');
    $field_options[] = array('name' => lang('Referring URL'), 'value' => 'http_referer');
    ...
    $field_options[] = array('name' => lang('Customer\'s IP Address'), 'value' => 'ip_address');
    $field_options[] = array('name' => lang('Product Name'), 'value' => 'product_name');
    ...
    $field_options[] = array('name' => lang('Payment'), 'value' => '<optgroup>');
    $field_options[] = array('name' => lang('Payment Method'), 'value' => 'payment_method', 'value_options' => array(array('name' => lang('Credit/Debit Card'), 'value' => 'Credit/Debit Card'), array('name' => lang('PayPal Express Checkout'), 'value' => 'PayPal Express Checkout'), array('name' => lang('Offline Payment'), 'value' => 'Offline Payment')));
    $field_options[] = array('name' => lang('Card Type'), 'value' => 'card_type');
    $field_options[] = array('name' => lang('Cardholder'), 'value' => 'cardholder');
    $field_options[] = array('name' => lang('Card Number'), 'value' => 'card_number');
    $field_options[] = array('name' => '', 'value' => '</optgroup>');
    $field_options[] = array('name' => lang('Billing'), 'value' => '<optgroup>');
    $field_options[] = array('name' => lang('Custom Field #1'), 'value' => 'custom_field_1');
    $field_options[] = array('name' => lang('Custom Field #2'), 'value' => 'custom_field_2');
    $field_options[] = array('name' => lang('Salutation'), 'value' => 'billing_salutation');
    $field_options[] = array('name' => lang('First Name'), 'value' => 'billing_first_name');
    $field_options[] = array('name' => lang('Last Name'), 'value' => 'billing_last_name');
    $field_options[] = array('name' => lang('Company'), 'value' => 'billing_company');
    $field_options[] = array('name' => lang('Address 1'), 'value' => 'billing_address_1');
    $field_options[] = array('name' => lang('Address 2'), 'value' => 'billing_address_2');
    $field_options[] = array('name' => lang('City'), 'value' => 'billing_city');
    $field_options[] = array('name' => lang('State'), 'value' => 'billing_state');
    $field_options[] = array('name' => lang('Zip Code'), 'value' => 'billing_zip_code');
    $field_options[] = array('name' => lang('Country'), 'value' => 'billing_country');
    $field_options[] = array('name' => lang('Phone'), 'value' => 'billing_phone_number');
    $field_options[] = array('name' => lang('Fax'), 'value' => 'billing_fax_number');
    $field_options[] = array('name' => lang('Email'), 'value' => 'billing_email_address');
    $field_options[] = array('name' => lang('Opt-In Status'), 'value' => 'opt_in_status', 'value_options' => array(array('name' => lang('Opt-In'), 'value' => '1'), array('name' => lang('Opt-Out'), 'value' => '0')));
    $field_options[] = array('name' => lang('PO Number'), 'value' => 'po_number');
    $field_options[] = array('name' => lang('Tax Status'), 'value' => 'tax_status', 'value_options' => array(array('name' => lang('Tax-Exempt'), 'value' => '1'), array('name' => lang('Not Tax-Exempt'), 'value' => '0')));
    $field_options[] = array('name' => '', 'value' => '</optgroup>');
    $field_options[] = array('name' => lang('Shipping'), 'value' => '<optgroup>');
    $field_options[] = array('name' => lang('Salutation'), 'value' => 'shipping_salutation');
    $field_options[] = array('name' => lang('First Name'), 'value' => 'shipping_first_name');
    $field_options[] = array('name' => lang('Last Name'), 'value' => 'shipping_last_name');
    $field_options[] = array('name' => lang('Company'), 'value' => 'shipping_company');
    $field_options[] = array('name' => lang('Address 1'), 'value' => 'shipping_address_1');
    $field_options[] = array('name' => lang('Address 2'), 'value' => 'shipping_address_2');
    $field_options[] = array('name' => lang('City'), 'value' => 'shipping_city');
    $field_options[] = array('name' => lang('State'), 'value' => 'shipping_state');
    $field_options[] = array('name' => lang('Zip Code'), 'value' => 'shipping_zip_code');
    $field_options[] = array('name' => lang('Country'), 'value' => 'shipping_country');
    $field_options[] = array('name' => lang('Address Type'), 'value' => 'shipping_address_type', 'value_options' => array(array('name' => lang('None'), 'value' => ''), array('name' => lang('Residential'), 'value' => 'residential'), array('name' => lang('Business'), 'value' => 'business')));
    $field_options[] = array('name' => lang('Phone'), 'value' => 'shipping_phone_number');
    $field_options[] = array('name' => lang('Ship to Name'), 'value' => 'ship_to_name');
    $field_options[] = array('name' => lang('Arrival Date Code'), 'value' => 'arrival_date_code');
    $field_options[] = array('name' => lang('Shipping Method Code'), 'value' => 'shipping_method_code');
    $field_options[] = array('name' => '', 'value' => '</optgroup>');
    ...
    if ($order_date_filter_exists == false) {
        ...
        if ((isset($_SESSION['software']['ecommerce']['view_order_report'][$session_index]['start_month']) == false)
            || !ctype_digit((string) $_SESSION['software']['ecommerce']['view_order_report'][$session_index]['start_year'])) {
        ...
        // else if the date has been passed in the query string, then set date in session
            ...
            if (checkdate($requested_range['start_month'], $requested_range['start_day'], $requested_range['start_year'])
                ...
                foreach ($requested_range as $date_part => $value) {
                    $_SESSION['software']['ecommerce']['view_order_report'][$session_index][$date_part] = sprintf(substr($date_part, -4) == 'year' ? '%04d' : '%02d', $value);
                }
            }
        }
        ...
        <div class="row justify-content-center justify-content-md-end">
            <div class="btn-group btn-group-sm col-auto py-0 px-1 my-1">
                <a class="btn py-0 px-1 border-start border-top border-bottom" href="view_order_report.php?start_month=' . $decrease_year['start_month'] . '&start_day=' . $decrease_year['start_day'] . '&start_year=' . $decrease_year['start_year'] . '&stop_month=' . $decrease_year['stop_month'] . '&stop_day=' . $decrease_year['stop_day'] . '&stop_year=' . $decrease_year['stop_year'] . $output_date_changer_query_string_id . '"><</a>
                <a class="btn py-0 px-1 border-bottom border-top" href="view_order_report.php?start_month=' . $current_year['start_month'] . '&start_day=' . $current_year['start_day'] . '&start_year=' . $current_year['start_year'] . '&stop_month=' . $current_year['stop_month'] . '&stop_day=' . $current_year['stop_day'] . '&stop_year=' . $current_year['stop_year'] . $output_date_changer_query_string_id . '">' . lang('Year') . '</a>
                <a class="btn py-0 px-1 border-end border-top border-bottom" href="view_order_report.php?start_month=' . $increase_year['start_month'] . '&start_day=' . $increase_year['start_day'] . '&start_year=' . $increase_year['start_year'] . '&stop_month=' . $increase_year['stop_month'] . '&stop_day=' . $increase_year['stop_day'] . '&stop_year=' . $increase_year['stop_year'] . $output_date_changer_query_string_id . '">></a>
            </div>
            <div class="btn-group btn-group-sm col-auto py-0 px-1 my-1">
                <a class="btn py-0 px-1 border-start border-top border-bottom" href="view_order_report.php?start_month=' . $decrease_month['start_month'] . '&start_day=' . $decrease_month['start_day'] . '&start_year=' . $decrease_month['start_year'] . '&stop_month=' . $decrease_month['stop_month'] . '&stop_day=' . $decrease_month['stop_day'] . '&stop_year=' . $decrease_month['stop_year'] . $output_date_changer_query_string_id . '"><</a>
                <a class="btn py-0 px-1 border-bottom border-top" href="view_order_report.php?start_month=' . $current_month['start_month'] . '&start_day=' . $current_month['start_day'] . '&start_year=' . $current_month['start_year'] . '&stop_month=' . $current_month['stop_month'] . '&stop_day=' . $current_month['stop_day'] . '&stop_year=' . $current_month['stop_year'] . $output_date_changer_query_string_id . '">' . lang('Month') . '</a>
                <a class="btn py-0 px-1 border-end border-top border-bottom" href="view_order_report.php?start_month=' . $increase_month['start_month'] . '&start_day=' . $increase_month['start_day'] . '&start_year=' . $increase_month['start_year'] . '&stop_month=' . $increase_month['stop_month'] . '&stop_day=' . $increase_month['stop_day'] . '&stop_year=' . $increase_month['stop_year'] . '">></a>
            </div>
            <div class="btn-group btn-group-sm col-auto py-0 px-1 my-1">    
                <a class="btn py-0 px-1 border-start border-top border-bottom" href="view_order_report.php?start_month=' . $decrease_week['start_month'] . '&start_day=' . $decrease_week['start_day'] . '&start_year=' . $decrease_week['start_year'] . '&stop_month=' . $decrease_week['stop_month'] . '&stop_day=' . $decrease_week['stop_day'] . '&stop_year=' . $decrease_week['stop_year'] . $output_date_changer_query_string_id . '"><</a>
                <a class="btn py-0 px-1 border-bottom border-top" href="view_order_report.php?start_month=' . $current_week['start_month'] . '&start_day=' . $current_week['start_day'] . '&start_year=' . $current_week['start_year'] . '&stop_month=' . $current_week['stop_month'] . '&stop_day=' . $current_week['stop_day'] . '&stop_year=' . $current_week['stop_year'] . $output_date_changer_query_string_id . '">' . lang('Week') . '</a>
                <a class="btn py-0 px-1 border-end border-top border-bottom" href="view_order_report.php?start_month=' . $increase_week['start_month'] . '&start_day=' . $increase_week['start_day'] . '&start_year=' . $increase_week['start_year'] . '&stop_month=' . $increase_week['stop_month'] . '&stop_day=' . $increase_week['stop_day'] . '&stop_year=' . $increase_week['stop_year'] . $output_date_changer_query_string_id . '">></a>
            </div>
            <div class="btn-group btn-group-sm col-auto py-0 px-1 my-1">    
                <a class="btn py-0 px-1 border-start border-top border-bottom" href="view_order_report.php?start_month=' . $decrease_day['start_month'] . '&start_day=' . $decrease_day['start_day'] . '&start_year=' . $decrease_day['start_year'] . '&stop_month=' . $decrease_day['stop_month'] . '&stop_day=' . $decrease_day['stop_day'] . '&stop_year=' . $decrease_day['stop_year'] . $output_date_changer_query_string_id . '"><</a>
                <a class="btn py-0 px-1 border-bottom border-top" href="view_order_report.php?start_month=' . $current_day['start_month'] . '&start_day=' . $current_day['start_day'] . '&start_year=' . $current_day['start_year'] . '&stop_month=' . $current_day['stop_month'] . '&stop_day=' . $current_day['stop_day'] . '&stop_year=' . $current_day['stop_year'] . $output_date_changer_query_string_id . '">' . lang('Day') . '</a>
                <a class="btn py-0 px-1 border-end border-top border-bottom" href="view_order_report.php?start_month=' . $increase_day['start_month'] . '&start_day=' . $increase_day['start_day'] . '&start_year=' . $increase_day['start_year'] . '&stop_month=' . $increase_day['stop_month'] . '&stop_day=' . $increase_day['stop_day'] . '&stop_year=' . $increase_day['stop_year'] . $output_date_changer_query_string_id . '">></a>
            </div>    
        </div>
    ...
    if ($output_order_report_name == '') {
        $output_order_report_name = '[' . lang('new order report') . ']';
    }
    ...
    pg_page_shell(
        array(
            'title'=> lang('Order Report') . ': ' . h($output_order_report_name),
...
<main id="content" class="container-fluid">
            ...
            <div class="col-12">
                ...
                <form name="form" id="edit_form" action="view_order_report.php" method="post" style="' . $output_edit_form_style . '">
                    ' . get_token_field() . '
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="detail">' . lang('Show Detail (Include Order Session Information)') . '</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-end">' . lang('Shipping') . '</th>
                                ...
                                foreach ($summarize_by_3_result['orders'] as $order) {
                                    ...
                                    print
                                        '<tr style="color: #969696" class="pointer" onclick="window.location.href=\'' . $output_link_url . '\'">
                                            <td colspan="3">&nbsp;</td>
                                            <td class="align-middle text-nowrap">' . $order['order_number'] . '</td>
                                            <td class="align-middle text-nowrap">' . get_relative_time(array('timestamp' => $order['order_date'])) . '</td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
...
// else the form has been submitted, so process form
    ...
    if ($liveform->get_field_value('submit_delete') == 'Delete') {
        ...
        log_activity(lang(array('string'=>'order report ({var:1}) was deleted','vars'=>$order_report_name)), $_SESSION['sessionusername']);
        $liveform->remove_form();
        $liveform_view_order_reports = new liveform('view_order_reports');
        $liveform_view_order_reports->add_notice(lang('The order report has been deleted.'));
    ...
    // else the user did not choose to delete the order report
        ...
        if ($liveform->field_in_session('id') == false) {
            ...
            $liveform->remove_form();
            $liveform->add_notice(lang('The order report has been created, and the results appear below.') . $order_date_filter_message);
    ...
    switch ($summarize_by) {
        ...
        case 'opt_in_status':
            if ($summarize_by_name == 1) {
                $summarize_by_name = lang('Opt-In');
            } else {
                $summarize_by_name = lang('Opt-Out');
            }
            break;
            
        case 'tax_status':
            if ($summarize_by_name == 1) {
                $summarize_by_name = lang('Tax-Exempt');
            } else {
                $summarize_by_name = lang('Not Tax-Exempt');
            }
            break;
            ...
            if ((mb_substr($card_number, 0, 1) != '*') && (mb_strlen($card_number) > 16)) {
                ...
                if (
                    ...
                    if (is_numeric($card_number) == FALSE) {
                        $card_number = '[' . lang('decryption error') . ']';
