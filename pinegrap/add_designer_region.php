...
if (!isset($_POST['name'])) {
    ...
    pg_page_shell([
        ...
        'heading_description' => lang('Create a designer region of shared content that can be added to any page style and updated during page editing by any Site designer.'),
