        ...
        if (REMEMBER_ME == TRUE) {
            ...
            $output_login_remember_me_checkbox = 
                '<tr>
                    ...
                    <td>' . $form->output_field(array('type'=>'checkbox', 'name'=>'login_remember_me', 'id'=>'login_remember_me', 'value'=>'1', 'class'=>'software_input_checkbox')) . '<label for="login_remember_me"> ' . lang('Remember Me') . '</label></td>
                </tr>';

            $output_register_remember_me_checkbox = 
                '<tr>
                    <td class="mobile_hide">&nbsp;</td>
                    <td>' . $form->output_field(array('type'=>'checkbox', 'name'=>'register_remember_me', 'id'=>'register_remember_me', 'value'=>'1', 'class'=>'software_input_checkbox')) . '<label for="register_remember_me"> ' . lang('Remember Me') . '</label></td>
                </tr>';
        }
            ...
            $output .=
                ...
                <div class="login" style="vertical-align: top; padding-top: 1em; padding-right: 2em">
                    ...
                    <form class="data" action="' . $action_url . '" method="post" class="software" style="margin: 0em">
                        ...
                        <button type="submit" name="submit_login" value="Login" class="software_input_submit_primary login_button">' . lang('Login') . '</button><br />
                        <br />
                        ' . $output_forgot_password_link . '
                    </form>
                </div>
