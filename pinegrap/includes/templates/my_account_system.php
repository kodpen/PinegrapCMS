...
<div style="margin-top: 1em">
	<div class="account mobile_width" style="margin-bottom: 1em; display: inline-block; vertical-align: top; width: 46%; margin-right: 5%">
		...
		<table class="data" style="margin-bottom: 2em">
			<tr>
				<td><?=h(lang('Username'))?>:&nbsp;</td>
				<td><?=h(USER_USERNAME)?></td>
			</tr>
			<?php if (!empty($google_account_notice)): ?>
			<tr>
				<td><?=h(lang('Sign-in'))?>:&nbsp;</td>
				<td><?=$google_account_notice?></td>
			</tr>
			<?php endif ?>
			<?php if ($start_page_url): ?>
			<tr>
				<td><?=h(lang('My Start Page'))?>:&nbsp;</td>
				<td><a href="<?=h($start_page_url)?>"><?=h($start_page_name)?></a></td>
			</tr>
			<?php endif ?>
			<?php if ($reward_points): ?>
			<tr>
				<td><?=h(lang('Reward Points'))?>:&nbsp;</td>
				<td><?=h(pg_format_number($reward_points, 0))?></td>
			</tr>
			<?php endif ?>
		</table>
	</div>
...
<div class="my_profile mobile_width" style="margin-bottom: 1em; display: inline-block; vertical-align: top; width: 46%; margin-right: 5%">
	...
	<div class="data" style="margin-bottom: 2em">
		...
		<?=h(lang('Main'))?>: <?=h($business_phone)?><br>
		<?php endif ?>
		<?php if ($mobile_phone): ?>
		<?=h(lang('Mobile'))?>: <?=h($mobile_phone)?><br>
		<?php endif ?>
		<?php if ($home_phone): ?>
		<?=h(lang('Home'))?>: <?=h($home_phone)?><br>
		<?php endif ?>
		<?php if ($business_fax): ?>
		<?=h(lang('Fax'))?>: <?=h($business_fax)?><br>
		<?php endif ?>
		<?php if ($timezone): ?>
		<?=h(lang('Timezone'))?>: <?=h($timezone)?><br>
		<?php endif ?>
	</div>
</div>
...
<div class="membership mobile_width" style="margin-bottom: 1em; display: inline-block; vertical-align: top; width: auto;">
	<div class="heading"><?=h(lang('Membership'))?></div>
	<div class="data" style="margin-bottom: 2em">
		<table>
			<tr>
...
<?php if ($affiliate): ?>
<div class="affiliate">
	<div class="heading"><?=h(lang('Affiliate'))?></div>
	<div class="data" style="margin-bottom: 2em">
		<table>
			<tr>
				<td><?=h(lang('Affiliate Name'))?>:</td>
				<td><?=h($affiliate_name)?></td>
			</tr>
			<tr>
				<td><?=h(lang('Affiliate Code'))?>:</td>
				<td><?=h($affiliate_code)?></td>
			</tr>
			<tr>
				<td><?=h(lang('Affiliate Link'))?>:</td>
				<td><a href="<?=h($affiliate_url)?>" target="_blank"><?=h($affiliate_url)?></a></td>
			</tr>
			<tr>
				<td><?=h(lang('Commission Rate'))?>:&nbsp;</td>
				<td><?=h($affiliate_commission_rate)?>%</td>
			</tr>
			<tr>
				<td><?=h(lang('Pending Total'))?>:</td>
				<td><?=pg_format_money($affiliate_pending_total, BASE_CURRENCY_SYMBOL)?></td>
			</tr>
			<tr>
				<td><?=h(lang('Payable Total'))?>:</td>
				<td><?=pg_format_money($affiliate_payable_total, BASE_CURRENCY_SYMBOL)?></td>
			</tr>
			<tr>
				<td><?=h(lang('Paid Total'))?>:</td>
				<td><?=pg_format_money($affiliate_paid_total, BASE_CURRENCY_SYMBOL)?></td>
			</tr>
		</table>
		<?php if ($commissions): ?>
		<div class="commissions">
			<div class="heading"><?=h(lang('Commissions'))?></div>
			<div class="data" style="padding-left: 20px; margin-bottom: 2em">
				<table style="width: 100%">
					<tr>
						<th style="text-align: left"><?=h(lang('Reference Code'))?></th>
						<th style="text-align: left"><?=h(lang('Date & Time'))?></th>
						<th style="text-align: left"><?=h(lang('Status'))?></th>
						<th style="text-align: right"><?=h(lang('Amount'))?></th>
					</tr>
...
<div class="order_history">
	<div class="heading" style="border: none; padding-bottom: .5em"><?=h(lang('Order History'))?></div>
	<div class="data" style="margin-bottom: 2em">
		<?php if ($complete_orders): ?>
		<div class="complete_orders">
			<div class="heading" style="margin-bottom: 7px"><?=h(lang('Complete Orders'))?></div>
			<div class="data" style="padding-left: 20px; margin-bottom: 15px">
				<table style="width: 100%">
					<tr>
						<th style="text-align: left"><?=h(lang('Order Number'))?></th>
						<th style="text-align: left"><?=h(lang('Date & Time'))?></th>
						<th style="text-align: right"><?=h(lang('Total'))?></th>
		...
		<div class="incomplete_orders">
			<div class="heading" style="margin-bottom: 7px"><?=h(lang('Incomplete Orders'))?></div>
			<div class="data" style="padding-left: 20px; margin-bottom: 15px">
				<table style="width: 100%">
					<tr>
						<th style="text-align: left"><?=h(lang('Reference Code'))?></th>
					...
					<tr class="row_<?=($key + 1) % 2?>">
						...
						<td style="vertical-align: top">
							...
							<a href="<?=h($order['order_url'])?>" class="software_button_small_primary" style="margin: 0 .5em .5em 0">&nbsp;&nbsp;<?=h(lang('Order'))?>&nbsp;&nbsp;</a>
							<?php else: ?>
							<a href="#" class="software_button_small_secondary" style="margin: 0 .5em .5em 0">&nbsp;<?=h(lang('Active'))?>&nbsp;&nbsp;</a>
							<?php endif ?>
							</span>
							<?php else: ?>
							...
							<?php endif ?>
							<a href="<?=h($order['delete_url'])?>" class="software_button_small_secondary" style="margin: 0 .5em .5em 0" onclick="return confirm('<?=h(escape_javascript(lang('The order will be deleted.')))?>')">
							<?=h(lang('Delete'))?>
							</a>
						</td>
					</tr>
...
<div class="address_book">
	...
	<table class="data" style="width: 100%">
		<tr>
			<th style="text-align: left"><?=h(lang('Ship to Name'))?></th>
			<th style="text-align: left"><?=h(lang('Full Name'))?></th>
			<th style="text-align: left"><?=h(lang('Delivery Address'))?></th>
			<th style="text-align: left">&nbsp;</th>
		</tr>
		...
		<tr class="row_<?=($key + 1) % 2?>">
			...
			<td style="vertical-align: top; padding-top: 5px">
				...
				<?php endif ?>
				<a href="<?=h($recipient['remove_url'])?>" class="software_button_small_secondary" style="margin: 0 .5em .5em 0" onclick="return confirm('<?=h(escape_javascript(lang(array('string' => '{var:1} will be removed.', 'vars' => array($recipient['ship_to_name'])))))?>')">
				<?=h(lang('Remove'))?>
				</a>
			</td>
		</tr>
