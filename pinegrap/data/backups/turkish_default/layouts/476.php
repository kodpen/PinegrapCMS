            ...
            ?>
                ...
                ?>
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" name="pending_offer_<?=$offer['id']?>_<?=$action['id']?>_add_name" id="pending_offer_<?=$offer['id']?>_<?=$action['id']?>_add_name" class="form-control" placeholder="yada isim ekle">
                    </div>
                <?php endif ?>
...
?>
    ...
    <h5><strong>Lütfen bağış fırsatlarını görüntülemek için Bağış Formunu kullanın.</strong></h5>

<?php
    // Otherwise there is at least one recipient, so show items.
    else:
?>
    <p class="text-center lead">Lütfen bağışlarınızı doğrulayın ve hediyenizi işleme koymak için 'Bağış Gönder'i tıklayın.</p>
    ...
    <form <?=$attributes?>>
        ...
        ?>
            ...
            <table class="table">
                ...
                <?php if ($show_surcharge): ?>
                    ...
                    <tr class="surcharge_row">
                        <th scope="row" class="text-right">Fazladan Vergi:</th>
            ...
            ?>
                <p class="text-muted">
                    <small>
                        *Bu tutar şu anki döviz kurumuz üzerinden <?=h($base_currency_name)?> üzerinden hesaplanmaktadır ve <?=h($base_currency_name)?> ücretlerinden tam olarak farklı olabilir.                    </small>
                </p>
            <?php endif ?>
        ...
        <?php if ($recurring_items): ?>
            ...
            <h4 class="mt64">Düzenli Bağış</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <h5 class="uppercase text-right">Yineleyen Toplam</h5>
    ...
    <?php if ($referral_source): ?>
        <div class="col-sm-4">
        <div class="form-group">
            <label for="referral_source">Bizden nasıl haberin oldu?</label>
            <div class="select-option">
                <i class="ti-angle-down"></i>
    ...
    <?php endif ?>
        ...
        <?php if ($applied_gift_cards): ?>
            ...
            <?php foreach($applied_gift_cards as $gift_card): ?>
                ...
                <a href="<?=h($gift_card['remove_url'])?>" class="remove-item" title="Kaldır">
                    <i class="ti-close"></i>
                </a>
