...
function get_photo_gallery($properties) {
    ...
    if ($layout_type == 'system') {
        ...
        if ($number_of_columns > 0) {
            ...
            if (isset($_GET['folder_id']) && ($_GET['folder_id'] != '') && ($folder_id != $_GET['folder_id'])) {
                    ...
                    switch ($access_control_type) {
                        ...
                        case 'membership':
                            ...
                            if (check_edit_access($folder_id) == false) {
                                ...
                                if (!$member_id) {
                                    output_error(lang(array('string' => 'Access denied. The album that you requested requires membership. Your {var:1} could not be found. You can view your membership status in your account area. Please contact us for more information.', 'vars' => array(h(MEMBER_ID_LABEL)))));
                                }
                                ...
                                if ($expiration_date < date('Y-m-d')) {
                                    output_error(lang('Access denied. The album that you requested requires membership. Your membership could not be verified.  You can view your membership status in your account area. Please contact us for more information.'));
                                }
                            }
                            break;
                    }
